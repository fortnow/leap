# **Prompt: Architecture for Proof by Pointing in First-Order Logic using LEAP**

Let me start by understanding what we're working with and what already exists in this project.Now I have a solid understanding of the concept. Let me design the architecture.
...
point(sequent, click\_target) → RuleApplication | Ambiguity | Error

1\. Resolve click\_target \= (side, address) to a subformula F
...
│   ├── sequent\_view.py \-- Interactive sequent rendering

│   ├── tree\_view.py    \-- Proof tree visualization

│   └── term\_input.py   \-- Dialog for term instantiation
